...
const TemperatureSensorChart = () => {
  ...
  const { temperature, timeArr } = useContext(ReadingsContext);
    ...
    <div className='min-h-[90vh] w-full flex-1 flex-col items-center justify-center px-4 py-6 sm:px-6 lg:px-8'>
      <div className='sm:flex sm:items-center'>
        <div className='sm:flex-auto'>
          <h1 className='text-xl font-semibold text-gray-900 lg:text-4xl'>
            Temperature Sensor Graph
          </h1>
          <p className='mt-2 text-sm text-gray-700'>
            A real time graph of the temperature measured by the sensor.
          </p>
        </div>
      </div>
